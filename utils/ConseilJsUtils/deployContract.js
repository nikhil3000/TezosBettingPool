...
const contract_code = require(`../../contract_build/${config.contractName}_compiled.tz`);
const contract_storage = require(`../../contract_build/${config.contractName}_storage_init.tz`);
